// ShopVibe - Wishlist (guest + logged-in), Cart
var GUEST_WISHLIST_KEY = 'shopvibe_guest_wishlist';
var GUEST_CART_KEY = 'shopvibe_guest_cart';
(function migrateGuestKeys() {
    try {
        if (!localStorage.getItem(GUEST_WISHLIST_KEY) && localStorage.getItem('shopwala_guest_wishlist')) {
            localStorage.setItem(GUEST_WISHLIST_KEY, localStorage.getItem('shopwala_guest_wishlist'));
        }
        if (!localStorage.getItem(GUEST_CART_KEY) && localStorage.getItem('shopwala_guest_cart')) {
            localStorage.setItem(GUEST_CART_KEY, localStorage.getItem('shopwala_guest_cart'));
        }
    } catch (e) {}
})();
...
$(document).on('submit', '.js-add-to-cart-form', function (e) {
    ...
    fetch('/api/cart', {
        ...
        .catch(function () {
            ...
            if (window.ShopVibe) ShopVibe.error('Could not add to cart. Please try again.');
...
(function () {
    ...
    document.addEventListener('click', function (e) {
        ...
        var nav = document.querySelector('.sv-navbar, .shopwala-navbar');
